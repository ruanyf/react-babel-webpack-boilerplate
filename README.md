...
- Use [AngularJS's commit message convention](https://github.com/angular/angular.js/blob/master/CONTRIBUTING.md#-git-commit-guidelines), with [Commitizen](https://github.com/commitizen/cz-cli) to produce formatted commit messages
